...
export const propertyPrompts: { [key: string]: string } = {
    description: "Take the provided summary of the project and rewrite it in the following format:\n\n**For** [target audience]\n**Who** [problem or need]\n**The** [product name] **Is** [product category]\n**That** [key benefit/reason to buy]\n**Unlike** [primary competitive alternative]\n**Our product** [statement of primary differentiation]\n\nUse simple language that anyone can understand. Give the response in complete MARKDOWN format only without any explanation. Remove any headings or titles and don't add extra information or fields. Use the language of the inputted data.Remove the top headings if any",
