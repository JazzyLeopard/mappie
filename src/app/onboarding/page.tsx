      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-16 max-w-5xl mx-auto text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Let&apos;s make you an even better product expert!
          </h1>
          ...
          <div className="relative flex justify-center items-center gap-6 mt-8 px-4">
            {/* Paste in text */}
            <Link href="/onboarding/paste" className="w-full max-w-[280px] transform -rotate-3 transition-transform hover:-translate-y-1">
            ...
            {/* Generate with AI */}
            <Link href="/onboarding/generate" className="w-full max-w-[320px] z-10 transform transition-transform hover:-translate-y-1">
            ...
            {/* Start from blank */}
            <Link href="/onboarding/blank" className="w-full max-w-[280px] transform rotate-3 transition-transform hover:-translate-y-1">
              <Card className="relative overflow-hidden">
                <div className="absolute inset-0 bg-violet-100">
                  <div className="absolute inset-0 opacity-50 bg-[url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-zAvuVlWQNWI5aCxXe0bIcdzozL79vz.png')] bg-contain bg-center bg-no-repeat" />
                </div>
