...
import { createUserStory } from '@/convex/userstories';


export const createUserStory = async (req: NextApiRequest, res: NextApiResponse) => {
  if (req.method === 'POST') {
    const userStoryId = await api.userstories.createUserStory({
      epicId: "123",
